...
if __name__ == '__main__':
    ...
    path = '/Users/juan-garassino/Code/juan-garassino/mySandbox/deepTechno/dataset/maestro/2018/'

    filename = 'MIDI-Unprocessed_Chamber2_MID--AUDIO_09_R3_2018_wav--1.midi'
    
    encoded = encode_midi(path+filename)
    
    print(encoded)
    
    path = '/Users/juan-garassino/Code/juan-garassino/mySandbox/deepTechno/results/'

    filename = 'test.mid'

    decoded = decode_midi(encoded, file_path=path+filename)

    ins = pretty_midi.PrettyMIDI(path+filename)
